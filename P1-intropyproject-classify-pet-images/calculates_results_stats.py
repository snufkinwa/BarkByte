...
def calculates_results_stats(results_dic):
    ...
    #Update counters by iterating through results_dic
    for key in results_dic:
        #Match between pet and classifier labels
        if results_dic[key][2] == 1:
            n_match += 1
        
        #Number of dogs increased when pet image 'is-a' dog
    ...
    # Populate results_stats_dic with counts and percentages
